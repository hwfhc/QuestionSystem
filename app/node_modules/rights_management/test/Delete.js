...
describe('Delete',function(){
    ...
    it('delete publish of user0',function(done){
        config.modules['rights_management'].Delete(0,'publish',function(){
    ...
    it('delete vie of user0',function(done){
        config.modules['rights_management'].Delete(0,'vie',function(){
            var sql_string = 'SELECT Rights FROM RightsTable WHERE ID=0';
    ...
    //I should add a test to add a right for user1
    //it(){}
