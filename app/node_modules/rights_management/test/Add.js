...
describe('Add',function(){
    ...
    before(function(done){
        config.modules['saferman'].sql('UPDATE RightsTable SET Rights="|publish|view" WHERE ID=0',function(){
            done();
        });
    });
