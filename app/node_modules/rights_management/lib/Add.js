...
function Add(ID,right,callback){
    ...
    function handleResultsOfSQL(sqlResults){
        ...
        function addRightForUser(){
            var sql = "UPDATE RightsTable SET Rights='" + sqlResults[0].Rights + "|" + right + "' WHERE ID=" + ID ;
